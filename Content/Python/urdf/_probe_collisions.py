...
Run in UE Editor Python console:
    from urdf._probe_collisions import run; run()
"""
import math
import os
import sys
...
# Ensure the urdf package is importable
...
def run(pa_path="/RammsAssets/Robots/KinovaGen3/Arm/SkeletalMeshes/gen3_6dof_PhysicsAsset"):
    """Run the collision probe on the given physics asset path."""
    ...
    print("=" * 80)
    print(f"=== Collision Diagnostic: {pa.get_name()} ===")
    print("=" * 80)
